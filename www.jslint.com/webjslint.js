...
return a.length===1?a[0]:a;},getContext:function(contextId){var a=[],b=this.___nodes___,i;for(i=0;i<b.length;i+=1){if(typeof b[i].getContext==='function'){a[i]=b[i].getContext(contextId);}}
